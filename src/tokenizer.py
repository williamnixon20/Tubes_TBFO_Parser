    ...
    for character in characters:
        ...
        for i in range(len(tempResult)):
            ...
            if flag_varname and not flag:
                ...
                if i == len(tempResult) - 1 or tempResult[i + 1] == 'COMA' or tempResult[i + 1] == 'RSB':
            ...
            elif tempResult[i] == 'EQ' or tempResult[i] == 'LB' or tempResult[i] == 'COLON':
                ...
                if i == len(tempResult) - 1:
                    list_exp.append(destruct_expr([x for x in curr_word]))
                    list_token.append("EXPR")
            elif flag_expression and tempResult[i] == 'RB' and curr_word != '':
                list_exp.append(destruct_expr([x for x in curr_word]))
                list_token.append("EXPR")
                list_token.append(tempResult[i])
                curr_word = ''
